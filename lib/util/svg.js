import { stringIsEmpty } from './strings.js'
 ...
 * @returns {string}
 */
export function getSvgCurve (x1, y1, x2, y2, color, additionalAttribute = '', tooltip = '') {
  let pathData
  ...
  return `<path class="line" d="${pathData}" fill="none" stroke="${color}" ` + additionalAttribute + `>${tooltip}</path>`
}
 ...
 * @returns {string}
 */
export function getSvgLine (x1, y1, x2, y2, color = 'black', filter = '', tooltip = '') {
 ...
 * @returns {string}
 */
export function getSvgConnectionLine (x1, y1, x2, y2, color = 'black', additionalAttribute = null, tooltip = '') {
  if (x1 === x2) {
 ...
 * @returns {string}
 */
export function getSvgConnectionAngle (x1, y1, x2, y2, color = 'black', additionalAttribute = null, tooltip = '') {
  if (x1 === x2) {
