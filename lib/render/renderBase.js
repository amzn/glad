  ...
  renderEdgesOfContainer (containers) {
    ...
    containerEdgeDeparture.forEach((valueSet, keySource) => {
      valueSet.forEach(target => {
        ...
        this.addPillCounter(sourceCenter, containerCounterForSources[keySource.id], 'green', 'white')
        this.addPillCounter(targetCenter, containerCounterForTargets[target.id], 'blue', 'white')
      })
    })
